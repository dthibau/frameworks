...
public class SwaggerBootstrap extends HttpServlet {
  ...
  /**
	 * 
	 */
	private static final long serialVersionUID = 8263664475743342954L;
	

@Override
  public void init(ServletConfig config) throws ServletException {
    Info info = new Info()
            .title("User Document Service")
            .description("This from the sample server Petstore server.  You can find out more about Swagger " +
